...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2022 at 04:01 PM
...
(1, '', '', '', '', '', '', '', 'Available', ''),
(2, 'amDH1qF/o+LgaKF1GclQ5YCSwNvAdzwakWjWcbXkUubm4hzY3/Eu4/FarSqOpupFftgxrBaYuTFxsEqbentZYVp0zPQWmcKUl4tHcjzw2WLWJYDFs7fFLgQxe00dG50NYNgKs5ahBRFD1OGFFOVtjUL7+P9kphAnPQds+a+O7gI=', 'Male', '10/1/1990', 'tsathishsec@gmail.com', '8124436310', 'trichy', 'A+', 'Available', ''),
(3, 'amDH1qF/o+LgaKF1GclQ5YCSwNvAdzwakWjWcbXkUubm4hzY3/Eu4/FarSqOpupFftgxrBaYuTFxsEqbentZYVp0zPQWmcKUl4tHcjzw2WLWJYDFs7fFLgQxe00dG50NYNgKs5ahBRFD1OGFFOVtjUL7+P9kphAnPQds+a+O7gI=', 'Male', 'PixMK/Kn/p+DV7c43Dil2jSlGIhyAhIlBhE1tPeXyWheuJXTJZQmr3FIC2+uSCSNiUIqLLvsi2O6Oi2PB/2xJdD+nvmwb42AfPEtTNVjyyxeu1oqqEL9FdOTD1an6Kkrr9GZOD256G6kh9pPKBFMlSDRp7R9+yDZr0AFsMziHrU=', 'sathishfantazy@gmail.com', 'abXbJaxFFX7bVPGPJH3h2k4KTt0AmWtOq92B6mHkZsEi4J+q5qK6FVSdfvWTbwyiLGqPgDAgs3wT7ZX+HQRG2esSE+XRgLfGYx+oUjXhfV7TrPTe8/DxoCtgq52AKD/5qYJo0vLDfEPn0CIA7qlccd5uD+Vpu6qaxtn7hMB/mjk=', 'lnI0S/MK3tkcKH4HjmwJtnkeW30s8hPeiIb+ouStFoKBI38nE7QtPqqNfTCyyfvLsT6MzYuurn+czCk6lfvnB5iar5vxo8qPuipaHVgX8KoE/0w6AAyHLVNpFtGkeFbc6WTnJVSCFkBrMXOSV6evBZWoCm5qMWORoHTPVMwNXHc=', 'LsAIkPA6sbm1kQF84SvVETZ9wWtXRRpKXOGuWkFX4rl55P0ggzXtnZ5E/2NY6ufnO1+0WQ/i7+1ya+eQOx1eiBTs2sksjieOm0ew/nH8S8cufnAmC/82qB11y9M+Ih3UBwffbrIkrKq8oZpc9b5xnGaiNdipW5X95DfHzmnl4Ig=', 'Available', ''),
...
--
ALTER TABLE `blood_bags`
  MODIFY `bagid` bigint(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `blood_donar`
--
ALTER TABLE `blood_donar`
  MODIFY `d_id` bigint(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `blood_requests`
--
ALTER TABLE `blood_requests`
  MODIFY `rid` bigint(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `userreg`
  MODIFY `uid` bigint(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
