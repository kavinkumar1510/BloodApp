...
public final class FragmentRequestBinding implements ViewBinding {
  ...
  private FragmentRequestBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listViewt,
      @NonNull TextView td) {
  ...
  public static FragmentRequestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRequestBinding((ConstraintLayout) rootView, listViewt, td);
    }
